...
public class DriverLocationController {
    ...
    /**
     * Lists GPS samples for a driver app user for a calendar day in UTC (00:00–24:00 UTC).
     * Depot managers may query drivers in their depot; central admins may query any driver user.
     */
    @GetMapping
    public ResponseEntity<ApiResponse<List<DriverLocationSampleDto>>> listSamples(
        ...
        List<DriverLocationSampleDto> samples = driverLocationService.listSamples(user, userId, day);
